...
public class MainWindowViewModel : ViewModelBase
{
    ...
    public ObservableCollection<MusicTrack> TrackList { get; set; } = new ObservableCollection<MusicTrack>();
    ...
    public void ShowEditTrackDialog()
    {
        ...
        {
            var dialog = new DialogAddWindow();
            dialog.DataContext = new DialogAddViewModel(this, dialog, SelectedItem);
